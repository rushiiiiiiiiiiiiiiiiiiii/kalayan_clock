...
import planetRing from '../assets/images/planetring.png'; // Update the path accordingly
...
const NoAdClock = () => {
  ...
  Ring_rotation = Ring_rotation-116
  let thekaran = "विष्टी"
  let theyog = "he"
  let thenaxatra = "he"
  ...
  return (
    <>
      ...
      <div className='container-fluid main '>
        ...
        <div className="container-fluid clock-container mt-1">
          ...
          <div className="clock" >
            ...
            { <div className="clock-background" style={{ transform: ` translateX(${originX}px) translateY(${originY}px) rotate(${Ring_rotation}deg)` }}>
              <img src={clockImage} alt="Kalayan Clock" className="clock-background" />
              <img src={planetRing} alt="Kalayan Clock" className="clock-background" /></div> 
              // <div className="clock-background" style={{ transform: ` translateX(${originX}px) translateY(${originY}px) rotate(${Ring_rotation}deg)` }}>
              // <img src={planetRing} alt="Kalayan Clock" className="clock-background" /></div>
              }
        ...
        {/* First Table Section */}
        <div className="d-flex vedind gap-0 justify-content-between w-full h-[211px]">
          {/* First Table */}
        ...
        {/* Tithi Table */}
        <table className="table tithitable bg-[light-purple] text-white shadow-lg rounded-lg mt-[-15px]">
          <tbody>
            ...
            <tr className="custom-border w-full ">
              <td className="py-3 text-left">दिनविशेष</td>
              <td></td>
              <td></td>
            </tr>
          </tbody>
        ...
        <div className='d-flex justify-content-between qrindved w-full m-auto mb-20' >
          <table className="table indvedgreg table-bordered table-striped table-hover max-h-[120px] m-auto">
            <tbody>
              <tr style={{ Height: '30px' }}>
                <th className='bg-dark text-white py-1'>Vikram Samvat Date</th>
