...
const VenusRotation = ({isVisible=true}) => {
  const [venusRotation, setVenusRotation] = useState(6);
  ...
  //   longitude: -23.5505,
  //   latitude: -46.6333,
  //   speed: 1.5 // Adjust speed to match the slower Venus rotation
  // };
  ...
  //                      const angle = Ring_rotation-254; // Adjust speed to match the desired rotation speed

  //       // Keep increasing the rotation angle beyond 360° (no modulo here)
  //       setVenusRotation(angle); // No % 360, allowing it to continue beyond 360°
  ...
  //       setVenusRotation((prev) => (prev + angle) % 360);
  //       animationId = requestAnimationFrame(updateRotation);
  //     };
  ...
  //       setVenusRotation((angle + 360) % 360); // Normalize between 0-360
  //       animationId = requestAnimationFrame(updateRotation);
  //     };
  ...
  //     setVenusRotation(config.customAngle % 360);
  //   }
  ...
  //       speed = 0.2,
  //       startTime,
  //       direction = "counterclockwise" // Venus has retrograde rotation
  //     } = apiConfig;
  ...
  //       setVenusRotation((angle % 360 + 360) % 360);
  //       animationId = requestAnimationFrame(updateRotation);
  //     };
